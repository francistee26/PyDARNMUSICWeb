...
var statusNormal = document.getElementById("statusNormal");
var warning = document.getElementById("warning");
var music_mark_incomplete = document.getElementById("music_mark_incomplete");
var music_mark_complete = document.getElementById("music_mark_complete");
music_mark_incomplete.onclick = function() {
  statusNormal.style.display = "statusNormal";
  warning.style.display = "None";
}
music_mark_complete.onclick = function () {
